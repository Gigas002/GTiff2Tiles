...
using GTiff2Tiles.NetCore.GUI.Enums;
using GTiff2Tiles.NetCore.GUI.Localization;
using GTiff2Tiles.NetCore.GUI.Models;
using GTiff2Tiles.NetCore.GUI.Properties;
using GTiff2Tiles.NetCore.GUI.Views;
...
namespace GTiff2Tiles.NetCore.GUI.ViewModels
{
    /// <inheritdoc />
    /// <summary>
