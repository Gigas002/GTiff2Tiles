...
Preferred way to build the solution is to use **VS2019 (16.7.1+)**, but you can also build projects, using dotnet CLI in your terminal or in **VSCode (1.47.3+)** with **omnisharp-vscode (1.23.0+)** extension.
