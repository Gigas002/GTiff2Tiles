...
Preferred way to build the solution is to use **VS2019 (16.8.1+)**, but you can also build projects, using dotnet CLI in your terminal or in **VSCode (1.51.1+)** with **ms-dotnettools.csharp (1.23.5+)** extension.
