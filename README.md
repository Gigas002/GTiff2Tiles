...
Preferred way to build the solution is to use **VS2022 (17.0.0+)**, but you can also build projects, using dotnet CLI in your terminal or in **VSCode (1.63.0+)** with **ms-dotnettools.csharp (1.23.16+)** extension.
