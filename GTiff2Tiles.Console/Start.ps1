...
# Run tiling from Input.tif file to Output directory for 8-11 zooms, tms-compatible, in 3-threads mode.
# ./GTiff2Tiles.Console -i "D:/Examples/Input.tif" -o "D:/Examples/Output" -t "D:/Examples/Temp" --minz 8 --maxz 11 --tms true --extension .webp --threads 3